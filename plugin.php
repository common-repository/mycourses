...
class MyCourses_Plugin
{
	...
	{
		register_activation_hook(basename(dirname($pluginfile)).'/'.basename ($pluginfile), 
	...
	{
		register_deactivation_hook(basename (dirname ($pluginfile)).'/'.basename ($pluginfile), 
